...
import { search, Message, DarkMode, LightMode, Notifications, Help, Menu, Close, Search } from "@mui/icons-material"
...
const Navbar = () => {
    ...
    const isNonMobileScreens = useMediaQuery("(min-width: 1000px)")      //mui hook
    ...
    return <FlexBetween padding="1rem 6%" backgroundColor={alt}>
        ...
        {!isNonMobileScreens && isMobileMenuToggled && (
            <Box position="fixed" right="0" bottom="0" height="1" height="100%" zIndex="10" maxWidth="500px" minWidth="300px" backgroundColor={background}>
